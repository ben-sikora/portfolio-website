  ...
  return (
    <div className="">
      <div className="flex mt-5">
          <a href="#" className= {`flex justify-center items-center font-display text-[1.3rem] grow-[1] basis-1/5 ${Styles.buttonAnnimation}`} > @bensikora </a>
          <ul className= 
          "flex justify-center items-center text-[1.3rem] font-display grow-[3] basis-3/5">
              <li className={`px-7 ${Styles.buttonAnnimation}`}><a href="#">About</a></li> 
              <li className={`px-7 ${Styles.buttonAnnimation}`}><a href="#">Projects</a></li>
              <li className={`px-7 ${Styles.buttonAnnimation}`}><a href="#">Experience</a></li>
