  ...
  return (
    ...
    <div className="" id="projects-page">
      <div className="flex flex-col items-center">
        ...
        <h4 className='font-writing text-[1.3rem] md:text-[1.5rem] font-[500] leading-10 text-center mb-5'>"Curiosity is at the center of all that I do. I believe that each new challenge has the potential to expand my understanding of myself and the world around me.”</h4>

        {contentBigProjects.map(function(contentBigProject, i){
            return <BigProject link={contentBigProject.link} img={contentBigProject.img} content={contentBigProject.content} logos={contentBigProject.logos} key={i} />;})}
        {/* 
